<div class="ibox float-e-margins animated fadeInUpBig">
    <div class="ibox-title">
        <h5>Geometría -
            <small> Ecuación general de la linea recta</small>
        </h5>
    </div>
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        <div class="row">
                                                            <div class="well">
                                                                <div class="row diff-wrapper">
                                                                    <div class="col-xs-12" align="center">
                                                                        <font size="3"><b>x + 3y + 10 = 0</b></font><br><br>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        <div class="row">
                                                            <div class="well">
                                                                <div class="row diff-wrapper">
                                                                    <div class="col-xs-12" align="center">
                                                                        <font size="3"><b>5x - 7y + 1 = 0</b></font><br><br>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
