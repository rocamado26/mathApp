<div class="ibox float-e-margins animated fadeInUpBig">
    <div class="ibox-title">
        <h5>Geometría - <small> Punto Pendiente</small></h5>
    </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse">
                        <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            Una ecuación lineal en su forma punto-pendiente nos proporciona la pendiente de una recta y las coordenadas de un punto en ella.
                                            <br><br>
                                            La forma punto-pendiente de una ecuación lineal se escribe como <b>(y - y<sub>1</sub>) = m (x - x<sub>1</sub>)</b>. En ésta ecuación, <b>m</b> es la pendiente y <b>(x<sub>1</sub>, y<sub>1</sub>)</b> son las coordenadas del punto.
                                            <br><br>
                                            ...
                                            <div class="well">
                                                <div class="row diff-wrapper">
                                                    <center>
                                                    <img src="{{asset('img/iconos/geometria/recta/puntopendiente/teoria.png')}}" width="350px">
                                                    </center>
                                                </div>
                                            </div>
                                            ...
                                            <br><br>
                                            Ahora digamos que uno de esos puntos es un punto genérico (x, y), lo cual significa que puede ser cualquier punto en la recta, y el otro punto es un punto específico, (x<sub>1</sub>, y<sub>1</sub>) . 
                                            <br><br>
                                                ...
                                                <div class="row diff-wrapper">
                                                    <center><b>
                                                        <table border="0">
                                                            <tr>
                                                                <td rowspan="2">m = </td>
                                                                <td style="border-bottom: 1px black solid;">Y – Y<sub>1</sub></td>
                                                            </tr>
                                                            <tr>
                                                                <td>X – X<sub>1</sub></td>
                                                            </tr>
