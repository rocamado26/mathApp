                            ...
                            <div id="collapseTwo" class="panel-collapse collapse" aria-expanded="false">
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="alert alert-info">
                                                <li>Ingresa los coeficientes para la función cuadrática.</li>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="alert alert-info">
                                                <li>Ingresa un valor para x, y así encontrar el punto geográfico</li>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-2">
                                            <input type="number" id="x2" placeholder="a" class="form-control" style="text-align: right">
                                        </div>
                                        <div class="col-xs-2">
                                            <button type="button" id="comprueba2" class="btn btn-primary btn-rounded"><i class="fa fa-check"></i>&nbsp;Comprobar</button>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6">
