<div class="ibox float-e-margins animated fadeInUpBig">
	<div class="ibox-title">
   	<h5>Funciones Polinomiales - <small> Cuadráticas</small></h5>
   </div>
              	...
              	<div class="panel-body">
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-6">
									      ...
									      Una <b>función cuadrática</b> o función de segundo grado es una función polinómica de <b>grado 2</b>, es decir, el mayor exponente del polinomio es <b>x</b> elevado a <b>2</b>(x<sup>2</sup>) y su gráfico es una curva llamada parábola cuyo dominio es el conjunto de los números reales.
									        Se define en general como una expresión de la forma:
									          <center>
									              <img src="img/iconos/funciones/polinomiales/cuadratica/fcuadratica.png" width="100%" style="position: center; max-width: 350px;"/>
									          </center>
							          <div class="panel panel-default">
							              <div class="panel-body">
							                  <b>Donde:</b>
							                 ...
							                 <br><br>
							                 <b>x : </b> Variable de la ecuación y con exponente maximo 2.
							                 <br><br>
										...
										<div class="col-lg-6 col-md-6 col-sm-6">
											...
											<p style="text-align: center;">
												Grafica de <strong id="valor">f ( x ) = 2 x <sup>2</sup> - x + 1</strong>
											</p>
										</div>
									</div><!-- row teoria -->
									<div class="row">
										<div class="ibox">
															...
															<div class="col-lg-8">
																	<div class="panel panel-default">
																			...
																			<div class="panel-body">
																				<div class="row">
																					<div class="col-lg-6">
																						<p>Roberto juega con sus amigos de lanzar una pelota desde el suelo hacia arriba. El profesor les dice que la altura alcanzada por la pelota en uno de esos lanzamientos responde a la ecuación:
																							<br><b>h = 40t – 5 t <sup>2</sup></b> .
																							<br>Haz una representación gráfica de esta situación.</p>
																					</div>
																					<div class="col-lg-6">
																						<center>
								                                  <img src="img/iconos/funciones/polinomiales/cuadratica/football.png" style="position: center; max-width: 128px;" width="100%">
								                            </center>
																					</div>
																				</div>
																			</div>
																	...
																	<div class="well" align="Justify">
																			<font size="3">
																				<p>Expresion que representa la altura: <b>h = 40t – 5 t <sup>2</sup> </b></p>
																				<p>Expresandola como función: f(t) = 40t – 5 t <sup>2</sup></p>
																			</font>
																	</div>
																	...
																	<div class="well" align="center">
																			<font size="3">
																				...
																				<center>
																					<img src="/img/iconos/funciones/polinomiales/cuadratica/t_e1_f_cuad.png" width="100%" style="position: center; max-width: 350px;"/>
																				</center>
																			</font>
																	</div>
																			...
																			<font size="3">
																				<center>
																					...
																					<p style="text-align: center;">
																						Grafica de <b>h = 40t – 5 t <sup>2</sup></b>
																					</p>
																				</center>
																			</font>
																	</div>
																		...
																		<div class="well" align="Justify">
																			<font size="3">
																				<p>Puedes notar como cambia la altura segun el tiempo</p>
																			</font>
																	</div>
															</div>
															<div class="col-lg-4">
	                                        ...
	                                        <br>El Recorrido es el resultado de evaluar la función.
	                                      </p>
																			</div>
																	</div>
															</div>
															...
															<div class="col-lg-8">
																	<div class="panel panel-default">
																			...
																			<div class="panel-body">
																				<div class="row">
																					<div class="col-lg-6">
																					<p>Grafica f (x) = x <sup>2</sup>. Determina su dominio y recorrido.</p>
																					</div>
																					<div class="col-lg-6">
																						<center>
								                                  <img src="img/iconos/funciones/polinomiales/cuadratica/maths.png" style="position: center; max-width: 128px;" width="100%">
								                            </center>
																					</div>
																				</div>
																			</div>
																	...
																	<div class="well" align="Justify">
																			<font size="3">
																				<p>En este caso disponemos de una función: <b>f( x ) = x <sup>2</sup> </b></p>
																			</font>
																	</div>
																	<p>Elaboramos tabla de datos.</p>
																	<br>
																	<div class="well" align="center">
																			<font size="3">
																				<p>Al disponer de una función podemos elaborar tabla de datos.</p>
																				<center>
																					<img src="/img/iconos/funciones/polinomiales/cuadratica/t_e2_f_cuad.png" width="100%" style="position: center; max-width: 350px;"/>
																				</center>
																			</font>
																	</div>
																	...
																	<div class="well" align="Justify">
																			<font size="3">
																				<p>Nota que los valores resultantes de evaluar la función son iguales o mayores a cero.</p>
																				<p>Entonces:</p>
																				<p>&emsp;&emsp; Recorrido: <b>[0, + &infin;[</b> </p>
																			</font>
																	</div>
															</div>
															<div class="col-lg-4">
                                  ...
                                  <div class="panel-body">
                                      <p style="text-align: justify;">
																				Para funciones f ( x ) = x <sup>2</sup>; la grafica es una parábola que pasa por el origen.
                                      </p>
                                  </div>
                              	</div>
																	<div class="panel panel-warning">
															...
															<div class="col-lg-8">
																	<div class="panel panel-default">
																			...
																			<div class="panel-body">
																				<div class="row">
																					<div class="col-lg-6">
																					<p>Grafíca f ( x ) = – x <sup>2</sup> + 2x + 3 Determina dominio y recorrido.</p>
																					</div>
																					<div class="col-lg-6">
																						<center>
								                                  <img src="img/iconos/funciones/polinomiales/cuadratica/function.png" style="position: center; max-width: 128px;" width="100%">
								                            </center>
																					</div>
																				</div>
																			</div>
																	...
																	<div class="well" align="Justify">
																			<font size="3">
																				<p>En este caso disponemos de una función: <b>f ( x ) = – x <sup>2</sup> + 2x + 3</b></p>
																			</font>
																	</div>
																	<p>Elaboramos tabla de datos.</p>
																	<br>
																	<div class="well" align="center">
																			<font size="3">
																				<p>Al disponer de una función podemos elaborar tabla de datos.</p>
																				<center>
																					<img src="/img/iconos/funciones/polinomiales/cuadratica/t_e3_f_cuad.png" width="100%" style="position: center; max-width: 350px;"/>
																				</center>
																			</font>
																	</div>
																	Graficamos los datos obtenidos.
																	...
																	<font size="3">
																		<center>
																			...
																			<p style="text-align: center;">
																				Grafica de <b>f ( x ) = – x <sup>2</sup> + 2x + 3</b>
																			</p>
																		</center>
																	</font>
																	</div>
																	...
																	<div class="well" align="Justify">
																			<font size="3">
																				<p>Nota que los valores resultantes de evaluar la función son iguales o menores a 4.</p>
																				<p>Entonces:</p>
																				<p>&emsp;&emsp; Recorrido: <b>]- &infin;,4]</b> </p>
																			</font>
																	</div>
															</div>
															<div class="col-lg-4">
                                  ...
                                  <div class="panel-body">
                                      <p style="text-align: justify;">
																				Para funciones f ( x ) = x <sup>2</sup>; la grafica es una parábola que pasa por el origen.
																				<br>El punto de corte con el eje Y se obtiene haciendo x = 0 en la ecuación de la parábola. Por tanto, será (0, 3).
																				<br>Cuado el coeficiente de x <sup>2</sup> es negativo la parábola es abierta hacia abajo, caso contrario será abierta hacia arriba.
                                      </p>
                                  </div>
                              	</div>
																	<div class="panel panel-warning">
																			...
																			<div class="panel-body">
																				<p style="text-align: justify;">
																					...
																					<br>El Dominio es el conjunto de números reales.
	                                        <br>El Recorrido es el resultado de evaluar la función.
																					<br>Sustituyendo f (x) por 0 en la función obtienes la ecuación de segundo grado <b>–x <sup>2</sup> + 2x + 3 = 0</b>, cuyas soluciones son x = –1, y x = 3; por tanto, los puntos de corte son (–1, 0), (3, 0)..
																				</p>
																			</div>
																	</div>
															</div>
										...
										<div id="tour1_11" class="col-lg-6 col-md-6 col-sm-6">
											...
											<br><br>
												f ( x ) =
													...
													<button type="button" id="btn33" onclick="fsigno(33)" style="display: none;" class="btn btn-danger"><b>-</b></button> <strong id="c">0</strong>
											</font>
										</div>
									</div>
									<div class="row">
...
function tgraf_02(){
	...
	{boundingbox: [-1, 90, 9, -5], axis:true, grid:true, showCopyright:false});
	var p1 = b_tgraf_02.create('point',[0,0], {name:'',size:4});
	var p1 = b_tgraf_02.create('point',[1,35], {name:'',size:4});
	var p1 = b_tgraf_02.create('point',[2,60], {name:'',size:4});
	var p1 = b_tgraf_02.create('point',[3,75], {name:'',size:4});
	var p1 = b_tgraf_02.create('point',[4,80], {name:'',size:4});
	var p1 = b_tgraf_02.create('point',[5,75], {name:'',size:4});
	var p1 = b_tgraf_02.create('point',[6,60], {name:'',size:4});
...
function tgraf_03(){
	...
	{boundingbox: [-3, 5, 4, -0.50], axis:true, grid:true, showCopyright:false});
	var p1 = b_tgraf_03.create('point',[-1,0], {name:'',size:4});
	var p1 = b_tgraf_03.create('point',[0,3], {name:'',size:4});
	var p1 = b_tgraf_03.create('point',[3,0], {name:'',size:4});
...
$("#resultadorecorrido").html('');
	...
	var valorc=$("#c").text();
	if(valora==0){
	toastr.error('El coeficiente de <b>a</b> no debe ser CERO','Error');
	}else{
		if ($("#opc1").prop('checked') || $("#opc2").prop('checked') || $("#opc3").prop('checked') || $("#opc4").prop('checked')) {
				if ($("#opc1").prop('checked')) {
					...
					while (nn<4) {
						...
						if (sig1==1 && sig2==1 && sig3==2) {
							var aux=(parseFloat(valora)*nn*nn)+parseFloat(valorb)*nn-parseFloat(valorc);
						}
						if (sig1==1 && sig2==2 && sig3==1) {
							var aux=(parseFloat(valora)*nn*nn)-parseFloat(valorb)*nn+parseFloat(valorc);
						}
						if (sig1==1 && sig2==2 && sig3==2) {
							var aux=(parseFloat(valora)*nn*nn)-parseFloat(valorb)*nn-parseFloat(valorc);
						}
						if (sig1==2 && sig2==1 && sig3==1) {
							var aux=-1*(parseFloat(valora)*nn*nn)+parseFloat(valorb)*nn+parseFloat(valorc);
						}
						if (sig1==2 && sig2==1 && sig3==2) {
							var aux=-1*(parseFloat(valora)*nn*nn)+parseFloat(valorb)*nn-parseFloat(valorc);
						}
						if (sig1==2 && sig2==2 && sig3==1) {
							var aux=-1*(parseFloat(valora)*nn*nn)-parseFloat(valorb)*nn+parseFloat(valorc);
						}
					...
					if ($("#opc3").prop('checked')) {
						...
						$("#resultadorecorrido").append('<p>El recorrido son todos los valores que resultan de evaluar la expresión con valores los valores del <b>Dominio</b></p><p align="center"><b>Recorrido:&nbsp;&nbsp;&nbsp;{'+rec+'}</b></p>');
							...
							toastr.error('Tiene que seleccionar la "Tabla de Datos"','Error');
						}
					}
			}
...
function tour1() {
	...
	},
	{
			element: "#tour1_11",
			title: "Paso 2",
			content: "Visualiza la función conformada con los valores seleccionados.",
			placement: "top",
			backdrop: true,
			backdropContainer: '#wrapper',
			onShown: function (tour){
	...
	},
	{
			element: "#tour1_12",
			title: "Paso 3",
			content: "Seleccione lo que desea visualizar.",
			placement: "top",
			backdrop: true,
			backdropContainer: '#wrapper',
			onShown: function (tour){
	...
	},
	{
			element: "#tour1_13",
			title: "Paso 4",
			content: "Presiona para resolver.",
			placement: "top",
			backdrop: true,
			backdropContainer: '#wrapper',
			onShown: function (tour){
